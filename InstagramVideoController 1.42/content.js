(function () {
    ...
    function updatePanel() {
        ...
        statusEl.textContent = activeVideo
            ? `Videos: ${videos.length} | ${activeVideo.paused ? 'Paused' : 'Playing'} | ${options.volumeMute ? 'Muted' : 'Unmuted'} | Vol ${Math.round(options.volumeSliderV * 100)}% | ${options.playbackRateV.toFixed(2)}x`
