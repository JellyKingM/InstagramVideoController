(function () {
    ...
    let movedInfoElement = null;
    let movedInfoVideo = null;
    let debugPanel = null;
    ...
    function hasMovedInfoForVideo(video) {
        return movedInfoElement &&
            movedInfoVideo === video &&
            movedInfoElement.dataset.instagramVideoControllerMovedInfo === 'true';
    }
    ...
    function attachMovedInfoToSideBox(video) {
        ...
        if (movedInfoElement.parentElement !== sideBoxInfo) {
            sideBoxInfo.replaceChildren();
            sideBoxInfo.appendChild(movedInfoElement);
        }
        return true;
    }
    ...
    function moveVideoOverlayInfoToSideBox(video) {
        ...
        if (attachMovedInfoToSideBox(video)) {
            clickMoreButton(movedInfoElement);
            return true;
        }
    ...
    function createDebugPanel() {
        ...
        const steps = [
            ...
            ['Hide aria-label=Video player', debugHideVideoPlayer],
            ['Run 1-2-3-4-5-6-12+hide', debugRunFullSequence],
            ['Cleanup side box', () => {
                cleanupSideBox();
                debugAnchor = null;
                debugOverlay = null;
    ...
    function debugMoveInfo() {
        ...
        if (attachMovedInfoToSideBox(video)) {
            debugInfoElement = movedInfoElement;
        ...
        movedInfoElement = debugInfoElement;
        movedInfoVideo = video;
        clickMoreButton(debugInfoElement);
    ...
    function debugRunFullSequence() {
        ...
        updatePanel();
        debugLog('1-2-3-4-5-6-12+hide sequence complete');
    }
